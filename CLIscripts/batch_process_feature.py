...
##### SCLC MDACC configs #####
channel_dict = {
        'nuclei': ['191Ir-Ir191', '193Ir-Ir193'],
...
#   'label_marker_file': "/project/Xie_Lab/zgu/xiao_multiplex/nsclc_multiTAP_work/marker_labels.txt",
  ...
  'label_marker_file': "/project/Xie_Lab/zgu/xiao_multiplex/sclc_multiTAP_work/sclc_marker_labels.txt",

  'channels_dict': channel_dict,
  'use_membrane': True
}

dir_out = '/project/Xie_Lab/zgu/xiao_multiplex/sclc_multiTAP_work'

# for NSCLC, the number of files is too large to be saved into one .pkl
